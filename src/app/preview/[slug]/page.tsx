...
import { Trade, SEOContent } from "@/lib/types";
...
export async function generateMetadata({
  ...
  const seo = (page.seo_content as SEOContent) ??
    generateSEOContent(page.trade as Trade, page.city, page.state, page.business_name, page.phone);
...
export default async function PreviewPage({
  ...
  const seo: SEOContent = (page.seo_content as SEOContent) ??
    generateSEOContent(
      page.trade as Trade,
      page.city,
      page.state,
  ...
  const location = `${page.city}, ${page.state}`;
        ...
        <div className="card mb-6">
          ...
          <div className="bg-white rounded-lg p-4">
            ...
            <div className="text-green-700 text-sm mt-1">
              ranklocal.com/pages/{trade}-{page.city.toLowerCase().replace(/\s+/g, "-")}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="card bg-gradient-to-br from-green-500/5 to-transparent">
                ...
                <div className="space-y-3">
                  ...
                  <input className="input-field" placeholder="Phone Number" disabled />
                  <input className="input-field" placeholder="Email" disabled />
                  <textarea className="input-field" placeholder="Describe your project..." rows={3} disabled />
              ...
              {[
                {
                  ...
                  desc: `${businessName} is fully licensed and insured in ${page.state}. Your property is protected on every job.`,
                },
                {
                  icon: "M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z",
                  title: "Fast Response Time",
                  desc: `We know ${page.city} — our local team provides same-day service and 24/7 emergency availability.`,
                },
                {
                ...
                <div key={item.title} className="card text-center">
                  ...
                  <p className="text-[var(--color-secondary)] mt-2 text-sm">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="card p-0 overflow-hidden">
              <div className="bg-[var(--color-input)] h-80 flex items-center justify-center">
                <div className="text-center">
                  <svg className="w-16 h-16 text-[var(--color-muted)] mx-auto mb-4" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                {
                  name: "Sarah M.",
                  text: `${businessName} was amazing! Fast, professional, and fair pricing. Best ${trade} service in ${page.city} by far.`,
                },
                {
                  name: "Mike R.",
            ...
            <div className="space-y-4">
              {seo.faqs.map((faq) => (
                <div key={faq.question} className="card">
                  ...
                  <p className="text-[var(--color-secondary)] mt-2">{faq.answer}</p>
                </div>
              ))}
            </div>
          </div>
